...
import ColoredLampService.Ports.*
import ColoredLampService.Models.*
import ColoredLampService.Adapters.*

/** An example of Hexagonal Architecture for a colored lamp. */
object ColoredLampService:
  /** The [[Port]]s of a colored lamp. */
  object Ports:
  ...
  /** The implementations of the [[Port]]s of a colored lamp. */
  object Models:
  ...
  /** The [[Adapter]]s of a colored lamp. */
  object Adapters:
